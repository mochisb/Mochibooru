...
CREATE TYPE "public"."post_status" AS ENUM('queued', 'processing', 'pending', 'published', 'rejected', 'failed');--> statement-breakpoint
...
CREATE TABLE "posts" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "posts_sha256_unique" UNIQUE("sha256")
);
--> statement-breakpoint
...
ALTER TABLE "post_revisions" ADD CONSTRAINT "post_revisions_actor_id_user_id_fk" FOREIGN KEY ("actor_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "post_tags" ADD CONSTRAINT "post_tags_post_id_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "post_tags" ADD CONSTRAINT "post_tags_tag_id_tags_id_fk" FOREIGN KEY ("tag_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "posts" ADD CONSTRAINT "posts_uploader_id_user_id_fk" FOREIGN KEY ("uploader_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "favorites_post_idx" ON "favorites" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX "revisions_post_idx" ON "post_revisions" USING btree ("post_id","created_at");--> statement-breakpoint
CREATE INDEX "post_tags_tag_idx" ON "post_tags" USING btree ("tag_id","post_id");--> statement-breakpoint
CREATE INDEX "posts_gallery_idx" ON "posts" USING btree ("status","rating","created_at","id");--> statement-breakpoint
CREATE INDEX "posts_uploader_idx" ON "posts" USING btree ("uploader_id","created_at");--> statement-breakpoint
CREATE INDEX "posts_processing_idx" ON "posts" USING btree ("status","updated_at");--> statement-breakpoint
